...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2019 at 10:56 AM
...
INSERT INTO `tbl_personnel` (`per_id`, `per_firstname`, `per_middlename`, `per_lastname`, `per_suffix`, `pos_id`, `per_gender`, `per_civil_status`, `per_status`, `per_address`, `per_date_of_birth`, `per_place_of_birth`, `per_date_of_original_appointment`, `per_eligibility`, `per_position`, `dept_id`, `per_designation`, `per_tin_no`, `per_gsis_bp_no`, `per_pagibig_no`, `per_plantilla_no`, `promote_id`, `per_contact_no`, `rank_id`, `bs_name`, `bs_year`, `bs_school`, `ms_name`, `ms_with_unit`, `ms_year`, `ms_school`, `dr_name`, `dr_year`, `dr_with_unit`, `dr_school`, `other_degree`, `other_year`, `other_school`, `per_salary`, `date_modified`, `per_step`, `per_benefit`) VALUES
(1, 'Mark', 'Darwin', 'Villarta', 'Da', 0, 'Male', 'Single', 'Job-Order', 'PCSD Building Sports Complex Road Sta. Monica Heights, Puerto Princesa City', '1995-07-11', 'Puerto Princesa City', '2019-07-11', 'CS', 'IT Assistant/Programmer', 0, 'EPRPD', '111-111-111', '111-111-111', '111-111-111', 12, 0, '+639096089309', 0, 'wew1', 1995, '2', 'mas  wew1', '2', 2001, 'school wew2', 'doc wew2', 2002, '2', 'school wew3', 'other3', 2003, 'school4', '10000', '2019-07-11', '1', ' fff,ggg                                                   \r\n\r\n                                     ');
...
--
ALTER TABLE `tbl_personnel`
  MODIFY `per_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

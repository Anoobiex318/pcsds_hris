                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                ...
                                                <select class="form-control show-tick main" name = "per_privilages" name="per_status">
                                                    <option></option>
                                   ...
                                   <!--  <div class="col-md-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                ...
                                                <select class="form-control show-tick" name="per_campus">
                                                    ...
                                                    <option>EZMED</option>
                                                    <option>EEED</option>
                                                    <option>DMO SOUTH</option>
                                                    <option>DMO NORTH</option>
                                                    <option>DMO CALAMIANES</option>
                                                    <option>EPRPD</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_bs_name" placeholder="Degree">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_bs_year" placeholder="YYYY">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_bs_school" placeholder="School">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_ms_name" placeholder=" Degree">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_ms_with_unit" placeholder="with_Units">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_ms_year" placeholder="YYYY">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_ms_school" placeholder="School">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_dr_name" placeholder="Degree">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_dr_with_unit" placeholder="with Units">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_dr_year" placeholder="YYYY">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="per_dr_school" placeholder="School">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-9">

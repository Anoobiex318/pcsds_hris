                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody>
                                  ...
                                  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM tbl_personnel LEFT JOIN tbl_position ON tbl_personnel.pos_id =tbl_position.pos_id LEFT JOIN tbl_department ON tbl_personnel.dept_id = tbl_department.dept_id ORDER BY per_id ASC");
                                    $display->execute();
                                  ...
                                  <td><a title="View/Print Info" href="print_personnel_report.php?per_id=<?php echo $row['per_id']?>"><?php echo $row['per_lastname'].", ".$row['per_firstname']." ".$row['per_middlename']; ?></a></td>
                          ...
                          <span class = "glyphicon glyphicon-eye-open" href="#" data-toggle="modal" data-target="#print_personel" aria-hidden = "true"> View Details</span>
                                    </a>                                  
                                  </td>
                                </tr>                           
                                     <?php 
                           ...
                           <?php
$con=mysqli_connect("localhost","root","","pcsds_hris");
// Check connection

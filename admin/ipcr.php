                    ...
                    <div id="print">
                        <div class="card" style="width: 49%; display: inline-block;">
                            <div class="per-files">
                                ...
                                <form method="POST" action="" >
                                    <a href="ipcr.php?per_id=<?php echo $per_id; ?>"><img src="img/folder.png" style="width: 100px; height: 80px; padding: 5px;"><br>
                        ...
                        <div class="card pull-right" style="width: 50%;">
                            <div class="per-files">
                                ...
                                $stmt=$con->prepare("SELECT * FROM tbl_files INNER JOIN tbl_personnel ON tbl_files.per_id = tbl_personnel.per_id where tbl_personnel.per_id = '{$_GET['per_id']}' && file_repo ='IPCR'");
                                    $stmt->execute();
                                    if($stmt->rowCount() > 0) {
